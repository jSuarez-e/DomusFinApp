...
export class SettingsPage implements OnInit {
  ...
  public async onEmailSubmit(): Promise<void> {
    ...
    try {
      ...
      const msg =
        err?.error?.message || "Error al actualizar el correo electrónico.";
      this.showToast(msg, "danger");
    } finally {
  ...
  public async submitAccountDelete(): Promise<void> {
    ...
    const confirmAlert = await this.alertController.create({
      ...
      message:
        "¿Está completamente seguro de que desea inactivar su cuenta? Esta acción no se puede deshacer de forma directa y perderá el acceso de forma inmediata.",
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            this.http
              .post(`${this.authService.apiUrlUsers}/delete-account`, {
                password,
              })
              .subscribe({
                next: () => {
                ...
                error: (err: any) => {
                  ...
                  const msg =
                    err?.error?.message ||
                    "La contraseña provista es incorrecta.";
                  this.showToast(msg, "danger");
                },
              });
          },
